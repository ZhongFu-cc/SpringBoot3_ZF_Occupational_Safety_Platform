...
public class MybatisPlusGeneratedBusinessReplenish {
	 ...
	 * jdbc 路径(自行替換)
	 */
	private static final String URL = "jdbc:mariadb://192.168.56.1:3306/zf_occupational_safety_platform";
	 ...
	 */
	private static final String PARENT = "tw.com.zf_occupational_safety_platform";
	...
	public static void main(String[] args) {
		...
		FastAutoGenerator.create(URL, USER_NAME, PASS_WORD)
				...
				.strategyConfig(builder -> {
					...
					builder.addInclude("company","company_job_type","company_course","job_type_course_category","department","department_course").addTablePrefix() // 设置过滤表前缀, sys_user設置成 user表,一般不用寫
